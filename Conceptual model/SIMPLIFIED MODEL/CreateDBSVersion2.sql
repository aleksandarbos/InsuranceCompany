...
/*==============================================================*/
create index RELATIONSHIP_25_FK on AGE_GROUP (
COEFF_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_34_FK on CAR (
CLIENT_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_22_FK on CLIENT (
POLICY_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_27_FK on CONTINENT (
COEFF_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_42_FK on DESTINATION (
ST_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_36_FK on INSURANCE_PACKAGE (
PL_ITEM_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_26_FK on INSURANCE_PACKAGE (
TOP_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_32_FK on ITEMS_OF_PACKAGE (
PACKAGE_ID ASC
)
go
...
/* Index: OWNER_FK                                              */
/*==============================================================*/
create index OWNER_FK on POLICY (
CLIENT_ID ASC
)
go
...
/*==============================================================*/
create index POSSIBLE_RISK_FK on POLICY (
R_ID ASC
)
go
...
/*==============================================================*/
create index FOR_CALCTULATION_FK on POLICY (
PDV_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_23_FK on POLICY (
II_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_30_FK on POLICY (
PACKAGE_ID ASC
)
go
...
/*==============================================================*/
create index INSURANCE_PRICE_FK on POLICY (
PL_ITEM_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_21_FK on PRICELIST_ITEM (
PRICELIST_ID ASC
)
go
...
/* Index: IN_NEED_FK                                            */
/*==============================================================*/
create index IN_NEED_FK on RATE_OF_PDV (
PDV_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_40_FK on RISK (
COEFF_ID ASC
)
go
...
/*==============================================================*/
create index RISK_OF_CAR_FK on RISK_OF_CAR (
CARID ASC
)
go
...
/*==============================================================*/
create index RISK_OF_CAR2_FK on RISK_OF_CAR (
R_ID ASC
)
go
...
/*==============================================================*/
create index RISK_OF_HOUSE_FK on RISK_OF_HOUSE (
R_ID ASC
)
go
...
/*==============================================================*/
create index RISK_OF_HOUSE2_FK on RISK_OF_HOUSE (
HOME_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_41_FK on STATE_OF_ORIGIN (
CONTINENT_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_31_FK on SUBJECT_OF_INSURANCE (
TP_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_37_FK on SUBJECT_OF_INSURANCE (
DST_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_38_FK on SUBJECT_OF_INSURANCE (
HOME_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_39_FK on SUBJECT_OF_INSURANCE (
CARID ASC
)
go
...
/*==============================================================*/
create index TRAVEL_ACTIVITY_TRAVEL_PURPOSE_FK on TRAVEL_ACTIVITY_TRAVEL_PURPOSE (
R_ID ASC
)
go
...
/*==============================================================*/
create index TRAVEL_ACTIVITY_TRAVEL_PURPOSE2_FK on TRAVEL_ACTIVITY_TRAVEL_PURPOSE (
TP_ID ASC
)
go
...
/*==============================================================*/
create index RELATIONSHIP_24_FK on TRAVEL_PURPOSE (
PACKAGE_ID ASC
)
go
